...
namespace ConsoleApp1.Services
{
    public class NewsService
    {
        ...
        //}
        public IObservable<Article> GetRelatedArticles(HashSet<string> keywords)
        {
            var observables = keywords.Select(keyword =>
                Observable.FromAsync(() => FetchArticlesAsync(keyword)).SelectMany(articles => articles));
        ...
        public IObservable<Article> RetrieveArticlesByKeywords(IEnumerable<string> keywords)
        {
